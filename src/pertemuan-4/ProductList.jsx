        ...
        <div className="p-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {filteredProducts.map((item) => (
                    ...
                    //     <p className="text-gray-500">Stock: {item.stock} left</p><br></br>
                    //     <p className="text-red-500">Price: ${item.price.toFixed(2)}</p>

                    //     <div className="mt-2">
                    //         {item.tags.map((tag, index) => (
                    //             <span key={index} className="bg-blue-200 text-black-700 px-2 py-1 text-xs rounded-full mr-2">
                    //                 {tag}
                    //             </span>
