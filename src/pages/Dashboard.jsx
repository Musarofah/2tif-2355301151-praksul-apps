...
export default function Dashboard() {
  return (
    <div id="dashboard-container" className="w-full h-full bg-base-100 text-base-content">

      <div className="flex-1 p-5">
        {/* Page Header */}
        <PageHeader title="Dashboard" breadcrumb="Order List">
          <div className="space-x-2">
            <button id="add-button" className="bg-green-600 text-white px-4 py-2 rounded-lg">
              Add
            </button>
            <button id="export-button" className="bg-blue-600 text-white px-4 py-2 rounded-lg">
              Export
            </button>
        ...
        {/* DaisyUI Modal */}
        <button className="btn mt-6" onClick={() => document.getElementById('my_modal_1').showModal()}>
          Open Modal
        </button>
